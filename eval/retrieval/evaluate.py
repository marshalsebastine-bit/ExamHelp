"""Run the manually labelled retrieval checks in queries.jsonl.

This measures *retrieval*, which is a supporting metric: whether the evidence for
a flag was findable. It is not product evaluation and must not stand in for it.
The mutation harness (tech doc 7.2) measures whether the tool flags correctly.
Both exist; they are reported separately (repo review 2.4).
"""
...
from corpus.retrieval import load_index, search

DEFAULT_QUERIES = ROOT / "eval" / "retrieval" / "queries.jsonl"
